...
SELECT a.id,
    ...
    a.identity_status,
    a.identity_source,
    a.identity_filled_at,
    a.identity_status_changed_at,
    a.discogs_thumb_url,
...
SELECT effective.id,
    ...
    effective.image_url,
    effective.identity_status,
    effective.identity_source,
    effective.identity_filled_at,
    effective.identity_status_changed_at,
    effective.discogs_thumb_url,
    effective.effective_label,
    effective.effective_artist,
    effective.effective_release_year,
    effective.pressing_id,
    effective.discogs_release_id,
